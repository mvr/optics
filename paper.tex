...
Suppose $\langle l, r \rangle : S \hto A$ is a lens, i.e. that that $rl = \id_S$ and $\langle lr \rangle = \langle \phi \times A \rangle$ for some $\phi : M \to M$. Then $p$ obeys the three lens laws.
\end{proposition}
\begin{proof}
