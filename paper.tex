...
= \; & \text{\todo{(Move all structure isomorphisms to one side of the coend, then appeal to coherence)}} \\
...
\todo{Once we know that $(-, -)_*$ is monoidal, the pentagon and triangle axioms should lift straight from $\C$ and we're done}
