...
\begin{definition}[Compare {\cite[Definition 5.1]{CoherenceForLenses}}]
  ...
  \item A symmetric monoidal extranatural family of morphisms $\varepsilon_X : X \otimes X^* \to I$, called \emph{counits}, natural with respect to the dualisable morphisms.
  \end{itemize}
\end{definition}
